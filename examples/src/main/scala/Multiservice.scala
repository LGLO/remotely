...
object Multiservice extends App {
  ...
  val stopA = NettyServer.serve(addr1, env1, monitoring = Monitoring.consoleLogger("[service-a]")).run
  ...
  val stopB = NettyServer.serve(addr2, env2, monitoring=Monitoring.consoleLogger("[service-b]")).run
